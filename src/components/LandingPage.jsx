        ...
        {products.map((items, i) => (
          <SwiperSlide key={i} className="group flex relative rounded-xl border-1 border-white/50 overflow-hidden items-center justify-center bg-white h-full">
            <Link to={`/product-dets/${items._id}`}>
              ...
              <div className="absolute w-full h-full flex flex-col items-center text-white font-ArvoBold font-semibold justify-center gap-y-10 top-0 left-0 backdrop-blur-[3px]">
                <h1 className="text-center text-3xl 2xl:text-5xl px-4">
                  {items.name}
                </h1>
                <p className="text-2xl 2xl:text-5xl font-Geist">
