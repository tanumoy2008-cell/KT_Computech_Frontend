  ...
  fetchProduct();
    ...
    const formSubmit = async (data) => {
        ...
        formData.append("id", id);
            ...
            if (
                JSON.stringify(newDescriptions) !== JSON.stringify(Product.description)
            ) {
                ...
                <div className='h-full w-[50%]'>
                    ...
                    <form onSubmit={handleSubmit(formSubmit)} className='flex flex-col gap-y-10'>
                        ...
                        <button type='button' onClick={()=> {
                         ...
                         className='w-full text-center py-3 outline-none rounded-lg text-white font-Jura uppercase text-2xl transition-colors duration-200 bg-zinc-400 active:bg-zinc-600'>Cancel</button>
                        </div>
                    </form>
                </div>
                </div>
