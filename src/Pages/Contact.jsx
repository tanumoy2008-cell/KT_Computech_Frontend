              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 rounded-lg border ${errors.name ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all duration-200`}
                    {...register("name", { 
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 rounded-lg border ${errors.email ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all duration-200`}
                    {...register("email", {
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 rounded-lg border ${errors.phone ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all duration-200`}
                    {...register("phone", {
                ...
                <div className="space-y-1">
                  ...
                  <textarea
                    ...
                    className={`w-full px-4 py-3 rounded-lg border ${errors.message ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all duration-200`}
                    {...register("message", { 
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-2">
                  <button
                    ...
                    className={`flex-1 inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-teal-600 hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 transition-colors duration-200 ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
                  >
                    {isSubmitting ? (
                      <>
          ...
          <motion.div variants={itemVariants} className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1 text-gray-600">123 Business Street, Suite 100<br />New York, NY 10001</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <a href="mailto:info@example.com" className="mt-1 text-teal-600 hover:text-teal-800 transition-colors duration-200">
                      info@example.com
                    </a>
            ...
            <div className="bg-white rounded-xl shadow-xl p-6 md:p-8">
              ...
              <div className="flex space-x-4">
                <a href="#" className="h-10 w-10 rounded-full bg-teal-100 text-teal-600 flex items-center justify-center hover:bg-teal-600 hover:text-white transition-colors duration-200">
                  <FaFacebook className="h-5 w-5" />
                </a>
                <a href="#" className="h-10 w-10 rounded-full bg-teal-100 text-teal-600 flex items-center justify-center hover:bg-teal-400 hover:text-white transition-colors duration-200">
                  <FaTwitter className="h-5 w-5" />
                </a>
                <a href="#" className="h-10 w-10 rounded-full bg-teal-100 text-pink-600 flex items-center justify-center hover:bg-pink-500 hover:text-white transition-colors duration-200">
                  <FaInstagram className="h-5 w-5" />
                </a>
                <a href="#" className="h-10 w-10 rounded-full bg-teal-100 text-teal-700 flex items-center justify-center hover:bg-teal-700 hover:text-white transition-colors duration-200">
